...
/* System Settings */
    ...
    noatm_timer = 1; //Time in minutes that players cannot deposit money after selling stolen gold.
    ...
    respawn_timer = 75; //How many seconds a player should wait, before being able to respawn. Minimum 5 seconds.
    ...
    restricted_uniforms[] = { "U_B_CombatUniform_mcam_tshirt", "U_B_CombatUniform_mcam_worn", "U_B_survival_uniform" };
    ...
    /* Vehicle Sell Prices */
    vehicle_sell_multiplier_CIVILIAN = .33; //Civilian Vehicle Garage Sell Price = Vehicle Buy Price * multiplier
